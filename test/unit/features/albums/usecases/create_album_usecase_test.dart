...
void main() {
  late CreateAlbumUseCase useCase;
  ...
  final tParams = CreateAlbumParams(
    title: 'Test Album',
    artistIds: ['artist-1'],
  );
  ...
  setUp(() {
    ...
    useCase = CreateAlbumUseCaseImpl(mockRepository);
  });

  group('CreateAlbumUseCase', () {
    test('should return created album when successful', () async {
      when(
        () => mockRepository.createAlbum(
